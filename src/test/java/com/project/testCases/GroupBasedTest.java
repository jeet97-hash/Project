...
public class GroupBasedTest extends BaseClass {
	...
	public void testReportSetup() {
		testCaseRowNumber = 1;
		ExtentHtmlReporter reporter = new ExtentHtmlReporter("./TestReports/GroupBasedSmokeTestReport.html");
		extent = new ExtentReports();
		extent.attachReporter(reporter);
	}
	
	@Test(priority=0,groups={"SmokeSuite","RegressionSuite"},alwaysRun=true)
	public void openURL(){
	...
	@Test(priority=1,groups={"SmokeSuite","RegressionSuite"})
	...
	@Test(priority=2 ,dependsOnMethods="loginSite",groups="SmokeSuite")
	...
	@Test(priority=3,dependsOnMethods="loginSite",groups={"SmokeSuite","RegressionSuite"})
	...
	@Test(priority=4,dependsOnMethods="searchProduct",groups="SmokeSuite")
	...
	public void updateTestCaseStatusAndTakeScreenshot(ITestResult result) {
		...
		if(result.getStatus()==ITestResult.SUCCESS) {
			...
			String path = "./Screenshots/PassedTestCases/Screenshot_GroupBasedSmokeTest_"+properties.getConfigData("browser")+"_"+result.getName()+".png";
		...
		if(result.getStatus()==ITestResult.FAILURE) {
			...
			String path = "./Screenshots/FailedTestCases/Screenshot_GroupBasedSmokeTest_"+properties.getConfigData("browser")+"_"+result.getName()+".png";
			TakeScreenshot.takeScreenshot(driver, path);
	...
	public void regressionTestReportSetup() {
		testCaseColumnNumber = 7;
		ExtentHtmlReporter reporter = new ExtentHtmlReporter("./TestReports/GroupBasedRegressionTestReport.html");
		extent = new ExtentReports();
		extent.attachReporter(reporter);
	}
	@Test(priority=2,dependsOnMethods="loginSite",groups="RegressionSuite")
	...
	@Test(priority=4,dependsOnMethods="loginSite",groups="RegressionSuite")
	...
	@Test(priority=5,dependsOnMethods="loginSite",groups="RegressionSuite")
	...
	@Test(priority=6,dependsOnMethods="loginSite",groups="RegressionSuite")
	...
	@Test(priority=7,dependsOnMethods="loginSite",groups="RegressionSuite")
	...
	@Test(priority=8,dependsOnMethods="loginSite",groups={"SmokeSuite","RegressionSuite"})
	...
	public void updateTestCaseStatusAndTakeScreenshotRegressionTest(ITestResult result) {
		//Create logger test
		String testName = result.getName().substring(0,1).toUpperCase()+result.getName().substring(1);
		logger = extent.createTest(testName);
		...
		if(result.getStatus()==ITestResult.SUCCESS) {
			...
			String path = "./Screenshots/PassedTestCases/Screenshot_GroupBasedRegressionTest_"+properties.getConfigData("browser")+"_"+result.getName()+".png";
			TakeScreenshot.takeScreenshot(driver, path);
	    ...
	    if(result.getStatus()==ITestResult.FAILURE) {
			...
			String path = "./Screenshots/FailedTestCases/Screenshot_GroupBasedRegressionTest_"+properties.getConfigData("browser")+"_"+result.getName()+".png";
			TakeScreenshot.takeScreenshot(driver, path);
